...
* Any requests to external JS and CSS would be wasted, as there are no
  advantages to be gained from caching shared files for a one-page website.

We tackled these two issues at various stages of the build, which I’ll cover
later.

...
It’s probably worth noting that I don’t actually like this idea of faux-IDs, but
if you _do_ need to flag something as being unique in CSS, I _do_ find it better
than using actual IDs themselves.

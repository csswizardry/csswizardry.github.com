...
relationship, and **using `@extend` incorrectly creates relationships around the
wrong criterion**. It would be like grouping your CD collection by the colour of
their covers: doable, but not a useful relationship to create.
